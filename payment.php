...
if($_SERVER['REQUEST_METHOD'] == 'POST'):
	...
	$params = array(
		...
		'RETURNURL' => 'http://localhost/PayPalPaymentsAdvancedLayoutB/success.php',  //Setup your return url.  This is where paypal will return when complete.  See my success.php page
		'ERRORURL' => 'http://localhost/PayPalPaymentsAdvancedLayoutB/error.php',  //Setup your error url.  This is where paypal will return when an error occurs.  See my error.php page
		'CANCELURL' => 'http://localhost/PayPalPaymentsAdvancedLayoutB/cancel.php',  //Setup your cancel url.  This is where paypal will return when the user cancels an order.  See my cancel.php page
...
?>
	<h3>Confirmation</h3>
	<p>Confirm order before payment.  Display the information from your form</p>
	<table>
		<thead>
			<tr>
				<th>Name</th>
	...
	Now we can use the secure token in the response to setup the redirect to paypal for payment
	<a href="<?php echo $url ?>?SECURETOKEN=<?php echo $responsedata['SECURETOKEN'] ?>&SECURETOKENID=<?php echo $responsedata['SECURETOKENID'] ?>&MODE=TEST">Pay With PayPal</a>
	

<?php else: ?>
<h3>Put your form here.  Whatever you want to capture.</h3>
